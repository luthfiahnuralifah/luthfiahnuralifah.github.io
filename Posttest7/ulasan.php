...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['search'])) {
        $search_term = clean_input($_POST['search']);
    }
}

$sql = "SELECT * FROM ulasan_pengguna WHERE nama LIKE ? ORDER BY tanggal_kunjungan DESC";
$stmt = $koneksi->prepare($sql);
...
<body>
    ...
    <main class="ulasan-container">
        ...
        <div class="search-form">
            <h2>Cari Ulasan</h2>
            <form method="POST">
                <input type="text" name="search" placeholder="Cari berdasarkan nama" value="<?php echo htmlspecialchars($search_term); ?>">
